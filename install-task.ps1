# Registers (or updates) the "JevDaily" scheduled task for the current user.
#   .\install-task.ps1                 # every day at 07:30
#   .\install-task.ps1 -At 06:00
#   .\install-task.ps1 -Uninstall
param(
    [string]$At = "07:30",
    [string]$TaskName = "JevDaily",
    [switch]$Uninstall
)
...
Register-ScheduledTask -TaskName $TaskName -Action $action -Trigger $trigger -Settings $settings `
    -Description "Collects TypeSafe/Jev news and reactions and renders site\index.html" -Force | Out-Null
